        ...
        <div class="menu-grid">
            ...
            <c:if test="${empBean.pos_id !='E04' }">
                <a href="ApplicationServlet" class="menu-card card-creation">
                    <div class="menu-icon" style="color:#2196f3;"><i class="fa-solid fa-pen-to-square"></i></div>
            ...
            <a href="ApplicationHistoryServlet" class="menu-card card-history">
                <div class="menu-icon" style="color:#5c6bc0;"><i class="fa-solid fa-file-lines"></i></div>
            ...
            <c:if test="${empBean.pos_id !='E00' }">
                <a href="ApplicationWaitList" class="menu-card card-approval">
                    <div class="menu-icon" style="color:#424242;"><i class="fa-solid fa-list-check"></i></div>
            ...
            <c:if test="${fn:contains(empBean.dpt_id, 'D4')}">
                <a href="EmployeeInfo" class="menu-card card-hr">
                    <div class="menu-icon" style="color:#00796b;"><i class="fa-solid fa-address-card"></i></div>
            ...
            <c:if test="${empBean.dpt_id =='D200' }">
                <a href="ApplicationStatus" class="menu-card card-admin">
					<div class="menu-icon" style="color:#e53935;"><i class="fa-solid fa-file-invoice-dollar"></i></div>                    
